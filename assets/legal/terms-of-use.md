...
A digital wallet for the Australian construction and trade workforce. You add your work licences, certificates and induction records; we render them in a tap-to-copy form so you can fill site induction forms quickly.

We are not a substitute for the original licence document. The wallet is a **convenience layer** — the underlying licence and its issuing authority remain authoritative. If a site requires the physical card, you must still present it.
...
- Sign in by mobile number + one-time 6-digit code sent by SMS (or by email, where you provide one).
- Keep your mobile and any sign-in email secure. We treat anyone able to receive your one-time code as you.
...
- Use EQ Cards to store or share licences that aren't yours
- Forge, alter, or fabricate licence data
- Upload licence photos that are not authentic
- Reverse-engineer, decompile, or attempt to extract source code beyond what's reasonable for personal interoperability
- Use the OCR functionality to bulk-process documents that aren't yours (rate-limiting may be applied)
- Disrupt the service through abuse, automated access, or denial-of-service patterns
...
You retain ownership of everything you enter — your profile, your licences, your photos. By uploading them, you grant us a limited licence to:
...
EQ Cards is a wallet, not a compliance tool. The presence of a licence in your wallet:

- Does **not** mean the licence is currently valid (rely on the original issuer)
- Does **not** mean you are legally permitted to perform any specific work (employment, ticketing, and site requirements are the employer's call)
- Does **not** constitute proof of currency for legal or insurance purposes

We don't give legal, professional, safety, or compliance advice. Consult the relevant authority for anything that matters.
